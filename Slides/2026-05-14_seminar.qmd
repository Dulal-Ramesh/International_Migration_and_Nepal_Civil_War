...
htmltools::HTML(
  paste(
    readLines("../Paper/Tables/Tables_Main/7a.DiD_Regression.html", encoding = "UTF-8"),
    collapse = "\n"
  )
)
```
<!-- In order to comment under Quarto
...
```{r, echo=FALSE, results='asis'}
cat(readLines ("../Paper/Tables/Tables_Main/9a.SubCohort_DiD.html", encoding = "UTF-8"),
    sep = "\n")
```

cat(readLines(../Paper/Tables/Tables_Main/9a.SubCohort_DiD.html, encoding = "UTF-8"), sep = "\n")

\begin{table}[!h]
\centering
\caption{\label{tab:tab:sample_construction}Sample Construction}
\centering
...
\midrule
Panel A: From raw data to cleaned sample &  &  \vphantom{1} & \\
...
\item Cohort definitions are based on age at conflict onset (1996): treatment = age 0-17, control = age 18-40. Current-age windows in 2017 (18-45 for treatment; 47-65 for control) ensure both cohorts are working-age adults at survey.

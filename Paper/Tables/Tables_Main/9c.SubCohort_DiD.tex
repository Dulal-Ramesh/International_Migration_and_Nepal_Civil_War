\begin{table}[!h]
\centering
\caption{\label{tab:subcohort_did_9c}Sub-Cohort DiD: Return Migrant (=1) (Sub-Cohort Decomposition by Developmental Window)}
\centering
...
\hspace{1em}HC × Sub-Cohort & -1.07 & -2.37*** & -1.15\\
\hspace{1em} & (0.71) & (0.80) & (0.95)\\
\hspace{1em}Observations & 17,484 & 16,623 & \vphantom{1} 14,283\\
\addlinespace[0.6em]
\multicolumn{4}{l}{\textbf{Panel B: High-Conflict Districts defined by Casualties}}\\
\hspace{1em}HC × Sub-Cohort & -1.44** & -2.33** & -2.01**\\
\hspace{1em} & (0.69) & (0.89) & (0.90)\\
\hspace{1em}Observations & 17,484 & 16,623 & 14,283\\
\bottomrule
\end{tabular}
\begin{tablenotes}
\item \textit{Notes:} 
